...
const runtimeModulePath = "github.com/dipjyotimetia/openapi-gen-go-mcp"
...
type ScaffoldOverrides struct {
	...
	// pin its dependency on the openapi-gen-go-mcp runtime to. Empty =
...
const scaffoldMainTemplate = `// Code generated by openapi-gen-go-mcp. DO NOT EDIT.
//
...
{{- end}}
	...
	"{{.PkgImport}}"
	"github.com/dipjyotimetia/openapi-gen-go-mcp/pkg/runtime/{{.Adapter}}"
)
...
func renderScaffoldReadme(opts Options, doc *openapi3.T, schemes []SecurityScheme, sdk string) string {
	...
	fmt.Fprintf(&b, "Generated by `openapi-gen-go-mcp` in **proxy mode**. This module proxies MCP tool calls to the upstream HTTP API described by the OpenAPI spec.\n\n")
